...
bool loadPng(GLubyte *loadhere, int &picWidth, int &picHeight, int &realPicWidth, int &realPicHeight, FILE *fp, bool reserve) {
...
bool loadByteArray(GLubyte *loadhere, int &picWidth, int &picHeight, int &realPicWidth, int &realPicHeight, FILE *fp, bool reserve) {
...
bool loadImage(GLubyte *loadhere, int &picWidth, int &picHeight, int &realPicWidth, int &realPicHeight, FILE *fp, int x, int y, bool reserve) {
	...
	if (!loadPng(loadhere, picWidth, picHeight, realPicWidth, realPicHeight, fp, reserve)) {
		if (!loadByteArray(loadhere, picWidth, picHeight, realPicWidth, realPicHeight, fp, reserve)) {
			return false;
		}
	}
